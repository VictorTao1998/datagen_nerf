...
if __name__ == "__main__":
    ...
    parser.add_argument("--nerf_obj", type=str, help="use nerf data")
    parser.add_argument("--split", type=str, help="use nerf data")
    ...
    data_root = osp.join(args.target_root, args.split)
    ...
    for sc in sub_scene_list:
        ...
        if done:
            ...
            continue
        # if not (args.primitives or args.primitives_v2):create_realsense_d415"), "r"))
