...
def main():
    data_dir = Path("/media/DATA/LINUX_DATA/rand_scenes/rand_scenes/")
    scene_id = "rand_scene_03-1"
    ...
    templcnl = cv2.imread(scene_dir / f"1024_irL_real_templcn2_ps{pattern_patch_size}.png", 0)
    templcnr = cv2.imread(scene_dir / f"1024_irR_real_templcn2_ps{pattern_patch_size}.png", 0)
